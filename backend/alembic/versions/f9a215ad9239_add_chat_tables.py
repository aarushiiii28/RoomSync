...
Revision ID: f9a215ad9239
Revises: f9a8b7c6d5e4
Create Date: 2026-08-31 13:04:56.470368
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('user_a_id < user_b_id', name='ck_conversation_ordered_users'),
